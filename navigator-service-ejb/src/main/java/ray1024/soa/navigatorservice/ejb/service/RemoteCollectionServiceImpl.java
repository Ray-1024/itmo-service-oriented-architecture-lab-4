...
public class RemoteCollectionServiceImpl implements RemoteCollectionService {
    ...
    @Override
    public List<RouteDto> getAll(int pageSize, int pageNumber, String sort, String filter) {
        try {
