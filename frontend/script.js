...
const modes = {
    ...
    getNavigator: {
        ...
        executeRequest: async function () {
            ...
            const url = new URL(`http://localhost:22402/api/v1/navigator/routes/${fields.routeFromName}/${fields.routeToName}/${fields.sorting}`);
            try {
                const response = await fetch(url, {
                    method: 'GET',
                    headers: {
    ...
    createNavigator: {
        ...
        executeRequest: async function () {
            ...
            utils.resultText('');
            const fields = utils.getFields();
            const url = new URL(`http://localhost:22402/api/v1/navigator/route/add/${fields.routeFromName}/${fields.routeToName}/${fields.routeDistance}`);
            try {
                const response = await fetch(url, {
